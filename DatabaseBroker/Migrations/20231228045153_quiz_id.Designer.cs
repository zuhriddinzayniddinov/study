...
namespace DatabaseBroker.Migrations
{
    ...
    [Migration("20231228045153_quiz_id")]
    partial class quiz_id
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entity.Models.Learning.Quiz", b =>
                {
                    b.HasOne("Entity.Models.Learning.Course", "Course")
                        .WithOne("Quiz")
                        .HasForeignKey("Entity.Models.Learning.Quiz", "CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entity.Models.Learning.Author", b =>
                {
                    ...
                    b.Navigation("SeminarVideos");

                    b.Navigation("ShortVideos");
                });
