...
public class PermissionRequirementFilter : IAsyncAuthorizationFilter
{
    ...
    {
        string? rawStructureId = context.HttpContext.User.FindFirstValue(CustomClaimNames.Structure);
        ...
        string? rawPermissionCodes = context.HttpContext.User.FindFirstValue(CustomClaimNames.Permissions);
